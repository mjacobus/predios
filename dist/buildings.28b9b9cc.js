...
},{"@stimulus/core":"../node_modules/@stimulus/core/dist/index.js"}],"../node_modules/turbolinks/dist/turbolinks.js":[function(require,module,exports) {
var define;
/*
Turbolinks 5.2.0
...
},{}],"app/controllers/base_controller.js":[function(require,module,exports) {
"use strict";
...
},{"stimulus":"../node_modules/stimulus/index.js"}],"app/utils.js":[function(require,module,exports) {
"use strict";
...
var apiPatch = function apiPatch(url, data) {
  return apiRequest(url, data, "PATCH");
};

exports.apiPatch = apiPatch;

var apiDelete = function apiDelete(url, data) {
  return apiRequest(url, data, "DELETE");
};

exports.apiDelete = apiDelete;
},{}],"app/controllers/apartment_removal_controller.js":[function(require,module,exports) {
"use strict";
...
var _base_controller = _interopRequireDefault(require("./base_controller"));
...
var ApartamentRemovalController =
/*#__PURE__*/
function (_BaseController) {
  _inherits(ApartamentRemovalController, _BaseController);

  function ApartamentRemovalController() {
    _classCallCheck(this, ApartamentRemovalController);

    return _possibleConstructorReturn(this, _getPrototypeOf(ApartamentRemovalController).apply(this, arguments));
  }

  _createClass(ApartamentRemovalController, [{
    key: "submit",
    ...
    key: "removeApartment",
    value: function removeApartment() {
      var _this = this;

      (0, _utils.apiDelete)("/api/buildings/any/apartments/".concat(this.apartmentUuid), {}).then(function (response, other) {
        return response.json().then(function (jsonResponse) {
          _this.handleResponse(jsonResponse, response);
        });
    ...
    key: "handleResponse",
    value: function handleResponse(jsonResponse, response) {
      if (response.status == 202) {
        this.hideElement(document.getElementById("apartment-".concat(this.apartmentUuid)));
        this.stopLoader();
        return;
      }

      var feedback = this.errorMessageTarget;
  ...
  return ApartamentRemovalController;
}(_base_controller.default);

exports.default = ApartamentRemovalController;
},{"./base_controller":"app/controllers/base_controller.js","../utils":"app/utils.js"}],"app/controllers/apartments_controller.js":[function(require,module,exports) {
"use strict";
...
var ApartmentsController =
/*#__PURE__*/
function (_BaseController) {
  _inherits(ApartmentsController, _BaseController);

  function ApartmentsController() {
    _classCallCheck(this, ApartmentsController);

    return _possibleConstructorReturn(this, _getPrototypeOf(ApartmentsController).apply(this, arguments));
  }

  _createClass(ApartmentsController, [{
    key: "submitForm",
    ...
    key: "createApartment",
    value: function createApartment() {
      var _this = this;

      this.beforeSubmit();
      (0, _utils.apiPost)(this.apartmentsEndpoint, this.payload).then(function (response, other) {
        return response.json().then(function (jsonResponse) {
          _this.handleResponse(jsonResponse, response);
        });
      }).catch(function (error) {
    ...
    value: function handleResponse(jsonResponse, response) {
      if (response.status >= 200 && response.status < 300) {
        _turbolinks.default.visit(this.buildingUrl);
    ...
    get: function get() {
      ...
      var buildingUuid = this.buildingUuid;
      var apartment = {
        number: number,
    ...
    key: "buildingUrl",
    get: function get() {
      return "/buildings/".concat(this.buildingNumber);
    }
  }, {
    key: "apartmentsEndpoint",
    get: function get() {
      return "/api/buildings/".concat(this.buildingNumber, "/apartments");
    }
  }, {
    key: "number",
    get: function get() {
    ...
    key: "targets",
    get: function get() {
      return ["number", "errorMessage", "buildingNumber", "buildingId", "buildingUuid"];
    }
  }]);
...
},{"./base_controller":"app/controllers/base_controller.js","turbolinks":"../node_modules/turbolinks/dist/turbolinks.js","../utils":"app/utils.js"}],"app/controllers/contact_attempt_controller.js":[function(require,module,exports) {
"use strict";
...
var ContactAttemptController =
/*#__PURE__*/
function (_BaseController) {
  _inherits(ContactAttemptController, _BaseController);

  function ContactAttemptController() {
    _classCallCheck(this, ContactAttemptController);

    return _possibleConstructorReturn(this, _getPrototypeOf(ContactAttemptController).apply(this, arguments));
  }

  _createClass(ContactAttemptController, [{
    key: "confirmContact",
    value: function confirmContact(e) {
      e.preventDefault();
      this.submit("contacted");
    }
  }, {
    key: "submitFailure",
    value: function submitFailure(e) {
      e.preventDefault();
      this.submit("failed");
    }
  }, {
    key: "submit",
    value: function submit(outcome) {
      var _this = this;

      this.startLoader();
      (0, _utils.apiPost)(this.endpoint, this.payload(outcome)).then(function (response, other) {
        return response.json().then(function (jsonResponse) {
          _this.handleResponse(jsonResponse, response);
        });
      });
    ...
    value: function handleResponse(jsonResponse, response) {
      if (response.status >= 200 && response.status < 300) {
        var url = "/buildings/".concat(this.buildingNumber);

        _turbolinks.default.visit(url);
    ...
    key: "payload",
    value: function payload(outcome) {
      var apartment_id = this.apartmentUuid;
      var time = this.time;
      var contact_attempt = {
        outcome: outcome,
    ...
    key: "endpoint",
    get: function get() {
      return "/api/buildings/".concat(this.buildingNumber, "/apartments/").concat(this.apartmentId, "/assign_visit_attempt");
    }
  }, {
    key: "apartmentId",
    get: function get() {
    ...
    key: "targets",
    get: function get() {
      return ["errorMessage", "number", "time", "buildingNumber", "apartmentId", "apartmentUuid"];
    }
  }]);

  return ContactAttemptController;
}(_base_controller.default);

exports.default = ContactAttemptController;
},{"./base_controller":"app/controllers/base_controller.js","turbolinks":"../node_modules/turbolinks/dist/turbolinks.js","../utils":"app/utils.js"}],"app/controllers/dialog_controller.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_BaseController) {
  _inherits(DialogController, _BaseController);

  function DialogController() {
    _classCallCheck(this, DialogController);

    return _possibleConstructorReturn(this, _getPrototypeOf(DialogController).apply(this, arguments));
  }
...
},{"./base_controller":"app/controllers/base_controller.js"}],"app/controllers/building_form_controller.js":[function(require,module,exports) {
"use strict";
...
var BuildingFormController =
/*#__PURE__*/
function (_BaseController) {
  _inherits(BuildingFormController, _BaseController);

  function BuildingFormController() {
    _classCallCheck(this, BuildingFormController);

    return _possibleConstructorReturn(this, _getPrototypeOf(BuildingFormController).apply(this, arguments));
  }

  _createClass(BuildingFormController, [{
    key: "saveBuilding",
    value: function saveBuilding(e) {
      var _this = this;

      e.preventDefault();
      this.startLoader();
      (0, _utils.apiPatch)("/api/buildings/".concat(this.buildingUuid), this.payload).then(function (response, other) {
        return response.json().then(function (jsonResponse) {
          _this.handleResponse(jsonResponse, response);
        });
      }).catch(function (error) {
    ...
    value: function handleResponse(jsonResponse, response) {
      if (response.status >= 200 && response.status < 300) {
        _turbolinks.default.visit("/buildings");

        return;
      }

      var feedback = this.errorMessagesTarget;
      feedback.innerHTML = jsonResponse.message;
      this.showElement(feedback);
      this.stopLoader();
    }
    ...
    key: "hasIndividualLetterboxes",
    get: function get() {
      return this.hasIndividualLetterboxesTarget.value;
    }
  }, {
    key: "hasIndividualIntercoms",
    get: function get() {
    ...
    get: function get() {
      var neighborhood = this.neighborhood,
          ...
          name = this.name;
      var number_of_apartments = this.numberOfApartments;
      var has_individual_letterboxes = this.hasIndividualLetterboxes;
      var has_individual_intercoms = this.hasIndividualIntercoms;
      return {
        building: {
          name: name,
          ...
          has_individual_letterboxes: has_individual_letterboxes,
          has_individual_intercoms: has_individual_intercoms
        }
      };
    }
  }], [{
    key: "targets",
    get: function get() {
      return ["errorMessages", "buildingUuid", "name", "hasIndividualLetterboxes", "hasIndividualIntercoms", "address", "numberOfApartments", "neighborhood"];
    }
  }]);

  return BuildingFormController;
}(_base_controller.default);

exports.default = BuildingFormController;
},{"./base_controller":"app/controllers/base_controller.js","turbolinks":"../node_modules/turbolinks/dist/turbolinks.js","../utils":"app/utils.js"}],"buildings.js":[function(require,module,exports) {
"use strict";
...
var _apartment_removal_controller = _interopRequireDefault(require("./app/controllers/apartment_removal_controller"));

var _apartments_controller = _interopRequireDefault(require("./app/controllers/apartments_controller"));

var _contact_attempt_controller = _interopRequireDefault(require("./app/controllers/contact_attempt_controller"));

var _dialog_controller = _interopRequireDefault(require("./app/controllers/dialog_controller"));

var _building_form_controller = _interopRequireDefault(require("./app/controllers/building_form_controller"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var application = _stimulus.Application.start();

application.register("apartments", _apartments_controller.default);
application.register("contact-attempt", _contact_attempt_controller.default);
application.register("dialog", _dialog_controller.default);
application.register("building_form", _building_form_controller.default);
application.register("apartment_removal", _apartment_removal_controller.default);

_turbolinks.default.start();
},{"stimulus":"../node_modules/stimulus/index.js","turbolinks":"../node_modules/turbolinks/dist/turbolinks.js","./app/controllers/apartment_removal_controller":"app/controllers/apartment_removal_controller.js","./app/controllers/apartments_controller":"app/controllers/apartments_controller.js","./app/controllers/contact_attempt_controller":"app/controllers/contact_attempt_controller.js","./app/controllers/dialog_controller":"app/controllers/dialog_controller.js","./app/controllers/building_form_controller":"app/controllers/building_form_controller.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","buildings.js"], null)
//# sourceMappingURL=/buildings.28b9b9cc.map